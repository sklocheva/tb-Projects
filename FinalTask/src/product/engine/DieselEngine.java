...
/**
 * The 'DieselEngine' class is a specific engine class which takes the
 ...
 *
 */
public class DieselEngine implements ProductValidationPlan {

	ArrayList<Integer> kwArray = new ArrayList<>(Arrays.asList(134, 245, 253, 331, 510));
	...
	public DieselEngine(String param) {
		this.param = param;
